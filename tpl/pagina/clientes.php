<!-- Meta -->
    ...
    <title>BSB-TI | Services :: Clientes</title>
</head>
<body>
...
<!-- Page Title -->
<div id="page-title">
    <h1 class="container">Clientes
    <span class="sub-title">Nossos clientes</span>
      ...
      <div class="one-fourth">
        ...
        <a href="<?php echo $p['link'];?>" target="_blank" title="<?php echo $p['nome'];?>">
          <div class="metro-box blue-gradient fullwidth">
            <img class="img-universal" src="<?php setHome(); echo '/uploads/clientes/'.$p['thumb'];?>" width="240" height="170"  />                                       
        </div>
      </a>
      </div>
      <!-- End of icon -->
